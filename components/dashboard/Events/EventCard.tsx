...
const EventCard = ({ event }: { event : Event}) => {
  ...
  const dateAbbreviations = {"september": "Sept", "october": "Oct", "november": "Nov", "december": "Dec", "january": "Jan", "february": "Feb", "march": "Mar", "april": "Apr", "may": "May", "june": "June", "july": "July", "august": "Aug"}
  const abbreviatedDesc = event.description?.length > 300 ? event.description.substring(0, 300) + " ..." : event.description;
  return (
