      ...
      <div className="flex flex-col w-full bg-gray-100 rounded shadow-lg">
        <div className="flex flex-col w-full lg:flex-row">
          <InternalLink
            ...
            className="flex flex-row gap-x-2 p-4 font-bold leading-none text-gray-800 uppercase bg-gray-400 rounded lg:flex-col lg:items-center lg:justify-center lg:w-1/4">
            ...
            <div className="md:text-xl lg:text-xl text-center ml-auto mr-0 lg:ml-auto lg:mr-auto">{`${date.split(" ")[4]} ${date.split(" ")[5]
              }`}</div>
          </InternalLink>
          <InternalLink
            href={`/events/${event.id}`}
            className="p-4 font-normal text-gray-800 lg:w-3/4 flex flex-col justify-start">
