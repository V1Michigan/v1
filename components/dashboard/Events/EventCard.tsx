  ...
  return (
    <div className="flex items-center justify-center sm:mx-4 md:mx-6 lg:mx-8 mb-8 hover:shadow-2xl hover:scale-105 hover:ease-in duration-100">
      <div className="flex flex-col w-full bg-gray-100 rounded shadow-lg">
        <div className="flex flex-col w-full lg:flex-row min-h-52">
          ...
          <div className="relative flex flex-row lg:pb-0 pb-4 justify-around font-bold leading-none text-gray-800 uppercase rounded lg:flex-col lg:justify-center lg:items-center lg:w-1/4">
