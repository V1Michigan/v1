                ...
                <div>
                    <div className="w-full">
                        ...
                        <div className="px-3 mt-10 mb-6">
                            <button
                                type="submit"
                                className={`bg-gradient-to-r from-yellow-200 to-yellow-500 hover:opacity-75 text-gray-800 font-semibold py-3 px-4 rounded shadow mb-4 ${submitted ? 'hidden' : 'block'
                                    } mx-auto`}
                                disabled={submitted}
                            >
                                Join the Discord
                            ...
                            <button
                                type="button"
                                className={`bg-gray-500 font-semibold text-gray-800 py-3 px-4 rounded shadow mb-4 ${submitted ? 'block' : 'hidden'
                                    } mx-auto`}
                                disabled
                            >
                                <svg
